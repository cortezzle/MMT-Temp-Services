...
namespace CortezFBLA
{
    public partial class NewEvaluation : Form
    {
        ...
        private void NewEvaluation_Load(object sender, EventArgs e)
        {
            ...
            employerSelectionBox.SelectedIndex = 0;
            ...
            if (employerSelectionBox.Items.Count == 0)
            {
        ...
        {
            if (employerSelectionBox.SelectedIndex == 0)
            {
            ...
            else
            {
                ...
                for (int i = 0; i < MainForm.Employees.Count; i++)
                {
                    ...
                    {
                         compName = currentEmployee.company.Substring(currentEmployee.company.IndexOf(' '));
                    }

                    if (compName != null && employerChosen.Contains(compName))
                    {
